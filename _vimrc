...
set statusline=[%n]%<%f%y%h%m%r%=\ [%{&fenc}:%{&ff}]\ [\%03.3b:\%02.2B]\ [%l,%v\ of\ %L][%p%%]
set report=0
...
if has("win32") || has("win64")
    set backupdir=$VIMRUNTIME/../data/backup " where to put backup file 
    set directory=$VIMRUNTIME/../data/swap " where to put swap file 
    set undodir=$VIMRUNTIME/../data/undo " where to put undo file 
else
